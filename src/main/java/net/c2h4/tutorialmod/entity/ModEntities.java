package net.c2h4.tutorialmod.entity;

import net.c2h4.tutorialmod.TutorialMod;
import net.c2h4.tutorialmod.entity.custom.DiceProjectileEntity;
import net.c2h4.tutorialmod.entity.custom.ModBoatEntity;
import net.c2h4.tutorialmod.entity.custom.ModChestBoatEntity;
...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<ModBoatEntity>> MOD_BOAT =
            ENTITY_TYPES.register("mod_boat", () -> EntityType.Builder.<ModBoatEntity>of(ModBoatEntity::new, MobCategory.MISC)
                    .sized(1.275f, 0.5625f).build("mod_boat"));

    public static final RegistryObject<EntityType<ModChestBoatEntity>> MOD_CHEST_BOAT =
            ENTITY_TYPES.register("mod_chest_boat", () -> EntityType.Builder.<ModChestBoatEntity>of(ModChestBoatEntity::new, MobCategory.MISC)
                    .sized(1.275f, 0.5625f).build("mod_chest_boat"));
