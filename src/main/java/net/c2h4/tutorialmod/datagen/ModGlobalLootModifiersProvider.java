...
import net.c2h4.tutorialmod.loot.AddItemModifier;
import net.c2h4.tutorialmod.loot.AddSusSandItemModifier;
...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("sapphire_staff_from_witch", new AddItemModifier(new LootItemCondition[]{
                LootTableIdCondition.builder(new ResourceLocation("entities/witch")).build()},
                ModItems.SAPPHIRE_STAFF.get()
        ));
